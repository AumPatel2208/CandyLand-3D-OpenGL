...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width = 5cm ]{texturemap.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width = 5cm ]{texturemap_labelled.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width = 5cm ]{texturemap_triangles.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width = 10cm ]{geometry_windwos.png}}
